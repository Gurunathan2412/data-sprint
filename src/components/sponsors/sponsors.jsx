...
const Sponsors=()=>{
    return(
        ...
        <div >
            { <a target="_blank" href="https://www.wewin.co.in/" className="company-btn" data-aos="zoom-in"><img src="https://res.cloudinary.com/dh2mrevv0/image/upload/v1728750100/WhatsApp_Image_2024-10-12_at_20.27.36_dc002bdc_kwecv7.jpg" alt=""/></a> }
            { <div className="spoName">Wewin Industrial Automations</div> }
           
                       
        </div>
        <div >
            { <a target="_blank" href="https://www.aghanyatechnology.com/" className="company-btn" data-aos="zoom-in"><img src="https://res.cloudinary.com/dh2mrevv0/image/upload/v1728750100/WhatsApp_Image_2024-10-12_at_20.27.37_4baa50ed_pof44r.jpg" alt=""/></a> }
